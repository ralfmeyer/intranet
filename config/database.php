    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'password' => env('DB_PASSWORD', '9aiCnh%!'),
        ...
        'mssrvx' => [
            'driver' => 'sqlsrv',
            'host' => env('DB_HOST', @'ep-sql\epsql'),
            // 'odbc_driver'   => '{ODBC Driver 16 for SQL Server}',
            //'port' => env('DB_PORT', '1433'),
            'odbc' => true,
            'port' => env('DB_PORT', '49395'),
            'database' => env('DB_DATABASE', 'eipro'),
            'username' => env('DB_USERNAME', 'sqlreader'),
            'password' => env('DB_PASSWORD', 'sqlReader123!'),
            'charset' => 'utf8',
            'prefix' => '',
        ],
